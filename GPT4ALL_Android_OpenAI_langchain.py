...
from config import BACKGROUND_IMAGE_PATH, RUN_BUTTON_NORMAL_IMAGE_PATH, SPEECH_BUTTON_NORMAL_IMAGE_PATH, RUN_PROGRAM_BUTTON_NORMAL_IMAGE_PATH
...
class TerminalApp(App):
    def build(self):
        ...
        background_image = Image(source=BACKGROUND_IMAGE_PATH, allow_stretch=True)
        ...
        run_button = ImageButton(source=RUN_BUTTON_NORMAL_IMAGE_PATH, size_hint=(None, 1), width=80)
        run_button.bind(on_press=self.execute_command)
        input_layout.add_widget(run_button)

        speech_button = ImageButton(source=SPEECH_BUTTON_NORMAL_IMAGE_PATH, size_hint=(None, 1), width=80)
        speech_button.bind(on_press=self.speech_to_text)
        input_layout.add_widget(speech_button)

        run_program_button = ImageButton(source=RUN_PROGRAM_BUTTON_NORMAL_IMAGE_PATH, size_hint=(None, 1), width=120)
    ...
    def execute_command(self, instance):
        ...
        if hasattr(self, 'process') and self.process.poll() is None:
            ...
            try:
                ...
                self.output_label.text += '\n$ ' + command + '\n' + output  # Print the command and output
    ...
    def run_program(self, instance):
        program_path = 'AppGPT4ALL_langchain.py'  # Specify the path of the program file
        output = ''
        try:
    ...
    def on_start(self):
        ...
        self.output_label.text += '\nClick the Aperture Science Speak button to use speech-to-text.'
        ...
        self.output_label.text += '\n!!!!! YOUR COMPUTER TERMINAL TO READ, WRITE, AND EDIT CODE!!!!!'
        self.output_label.text += '\n!!!!! AS WELL AS ACCESS THE INTERNET. USE WITH CAUTION!!!!!'
        self.output_label.text += '\n!!!!! THIS IS NOT A JOKE!!!!!'
        self.output_label.text += '\n!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!'        
